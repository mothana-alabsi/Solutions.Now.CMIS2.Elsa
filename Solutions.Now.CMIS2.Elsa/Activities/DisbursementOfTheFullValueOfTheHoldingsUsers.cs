...
namespace Solutions.Now.CMIS2.Elsa.Activities
{
    [Activity(
          Category = "Approval",
          DisplayName = "Disbursement Of The Full Value Of The Holdings approvals",
          Description = "Add Users of Disbursement Of The Full Value Of The Holdings approvals",
          Outcomes = new[] { OutcomeNames.Done }
      )]
    public class DisbursementOfTheFullValueOfTheHoldingsUsers : Activity
    {
        private readonly Cmis2DbContext _cmis2DbContext;

        public DisbursementOfTheFullValueOfTheHoldingsUsers(Cmis2DbContext cmis2DbContext)
        {
        ...
        {
            const int reducingTheHoldingRate = 662;
