...
namespace Solutions.Now.CMIS2.Elsa.Activities
{
    [Activity(
       Category = "Approval",
       DisplayName = "Add Ministry Engineer Warranty Users",
       Description = "Add Minisrty Engineer Warranty Users",
       Outcomes = new[] { OutcomeNames.Done }
   )]
    public class WarrantyMaintenanceWorkUserAddMinistryEng : Activity
    {
        private readonly Cmis2DbContext _cmis2DbContext;

        public WarrantyMaintenanceWorkUserAddMinistryEng(Cmis2DbContext cmis2DbContext)
        {
        ...
        protected override async ValueTask<IActivityExecutionResult> OnExecuteAsync(ActivityExecutionContext context)
        {
            ...
            try
            {
                users = await _cmis2DbContext.TblUsers.FirstOrDefaultAsync(u => u.Username.Equals(warrantyMaintenanceWork.ministryEngineer));
