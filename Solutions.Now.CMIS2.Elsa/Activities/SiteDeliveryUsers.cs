...
namespace Solutions.Now.CMIS2.Elsa.Activities
{
    [Activity(
          Category = "Approval",
          DisplayName = "Site delivery approvals",
          Description = "Add Users of Site delivery approvals",
          Outcomes = new[] { OutcomeNames.Done }
      )]
    public class SiteDeliveryUsers : Activity
    {
        private readonly Cmis2DbContext _cmis2DbContext;

        public SiteDeliveryUsers(Cmis2DbContext cmis2DbContext)
        {
        ...
        protected override async ValueTask<IActivityExecutionResult> OnExecuteAsync(ActivityExecutionContext context)
        {
            ...
            List<WorkFlowRules> workFlowRules = _cmis2DbContext.WorkFlowRules.AsQueryable().Where(s => (s.workflow == 437 && s.type == 441)).OrderBy(s => s.step).ToList<WorkFlowRules>();
            ...
            try
            {
                ...
                users = await _cmis2DbContext.TblUsers.FirstOrDefaultAsync(u => u.designer == tender.designer && u.Position == 424);
