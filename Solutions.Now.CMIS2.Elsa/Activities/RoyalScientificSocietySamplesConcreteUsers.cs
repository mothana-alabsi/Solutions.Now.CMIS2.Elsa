...
namespace Solutions.Now.CMIS2.Elsa.Activities
{
    [Activity(
          Category = "Approval",
          DisplayName = "Royal Scientific Society samples (concrete cubes) approvals",
          Description = "Add Users of Royal Scientific Society samples (concrete cubes) approvals",
          Outcomes = new[] { OutcomeNames.Done }
      )]
    public class RoyalScientificSocietySamplesConcreteUsers : Activity
    {
        private readonly Cmis2DbContext _cmis2DbContext;

        public RoyalScientificSocietySamplesConcreteUsers(Cmis2DbContext cmis2DbContext)
        {
        ...
        protected override async ValueTask<IActivityExecutionResult> OnExecuteAsync(ActivityExecutionContext context)
        {
            ...
            try
            {
                ...
                userNameDB[2] = userNameDB[13] = userNameDB[18] = users.Username;
