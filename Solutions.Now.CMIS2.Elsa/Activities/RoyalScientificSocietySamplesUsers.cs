...
namespace Solutions.Now.CMIS2.Elsa.Activities
{
    [Activity(
          Category = "Approval",
          DisplayName = "Royal Scientific Society samples approvals",
          Description = "Add Users of Royal Scientific Society samples approvals",
          Outcomes = new[] { OutcomeNames.Done }
      )]
    public class RoyalScientificSocietySamplesUsers : Activity
    {
        private readonly Cmis2DbContext _cmis2DbContext;

        public RoyalScientificSocietySamplesUsers(Cmis2DbContext cmis2DbContext)
        {
        ...
        protected override async ValueTask<IActivityExecutionResult> OnExecuteAsync(ActivityExecutionContext context)
        {
            ...
            try
            {
                ...
                userNameDB[14] = userNameDB[16] = users.Username;
