...
namespace Solutions.Now.CMIS2.Elsa.Activities
{
    [Activity(
          Category = "Approval",
          DisplayName = "Late Payments Disbursed approvals",
          Description = "Add Users of Late Payments Disbursed approvals",
          Outcomes = new[] { OutcomeNames.Done }
      )]
    public class LatePaymentsDisbursedUsers : Activity
    {
        private readonly Cmis2DbContext _cmis2DbContext;

        public LatePaymentsDisbursedUsers(Cmis2DbContext cmis2DbContext)
        {
        ...
        {
            const int latePaymentsDisbursed = 658;
            ...
            try
            {
                ...
                Tender tender = await _cmis2DbContext.Tender.FirstOrDefaultAsync(s => s.tenderSerial.ToString().Equals(financingExpenses.tenderSerial.ToString()));
                ...
                userNameDB[4] = userNameDB[8] = users.Username;
                ...
                userNameDB[0] = userNameDB[14] = users.Username;
                ...
                userNameDB[6] = userNameDB[11] = users.Username;
