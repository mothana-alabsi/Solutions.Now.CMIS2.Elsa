...
namespace Solutions.Now.CMIS2.Elsa.Controllers
{
    ...
    [ApiController]
    public class TheFirstInstallmentsController : ControllerBase
    {
        ISignaler _signaler;
        public TheFirstInstallmentsController(ISignaler signaler)
        {
            _signaler = signaler;
        }
        ...
        public async Task<IActionResult> Requset(int id)
        {
            ...
            await _signaler.TriggerSignalAsync("TheFirstInstallment", input:data);
            return Ok();
        }
    }
}
