...
namespace Solutions.Now.CMIS2.Elsa.Controllers
{
    ...
    [ApiController]
    public class InsurancePoliciessController : ControllerBase
    {
        ISignaler _signaler;
        public InsurancePoliciessController(ISignaler signaler)
        {
            _signaler = signaler;
        }
        ...
        public async Task<IActionResult> Requset(int id)
        {
            ...
            await _signaler.TriggerSignalAsync("InsurancePolicies", input:data);
            return Ok();
        }
    }
}
