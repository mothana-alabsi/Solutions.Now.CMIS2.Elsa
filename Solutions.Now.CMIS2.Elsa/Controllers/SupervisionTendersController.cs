...
namespace Solutions.Now.CMIS2.Elsa.Controllers
{
    ...
    [ApiController]
    public class SupervisionTendersController : ControllerBase
    {
        ISignaler _signaler;
        public SupervisionTendersController(ISignaler signaler)
        {
            _signaler = signaler;
        }
        ...
        public async Task<IActionResult> Requset(int id)
        {
            ...
            await _signaler.TriggerSignalAsync("SupervisionTender", input: data);
            return Ok();
        }
    }
}
