...
namespace Solutions.Now.CMIS2.Elsa.Controllers
{
    ...
    [ApiController]
    public class TheSecondInstallmentsController : ControllerBase
    {
        ISignaler _signaler;
        public TheSecondInstallmentsController(ISignaler signaler)
        {
            _signaler = signaler;
        }
        ...
        public async Task<IActionResult> Requset(int id)
        {
            ...
            await _signaler.TriggerSignalAsync("TheSecondInstallment", input:data);
            return Ok();
        }
    }
}
