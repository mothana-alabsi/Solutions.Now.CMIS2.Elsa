...
namespace Solutions.Now.CMIS2.Elsa.Controllers
{
    ...
    [ApiController]
    public class LaboratoryAccreditationsController : ControllerBase
    {
        ISignaler _signaler;
        public LaboratoryAccreditationsController(ISignaler signaler)
        {
            _signaler = signaler;
        }
        ...
        public async Task<IActionResult> Requset(int id)
        {
            ...
            await _signaler.TriggerSignalAsync("LaboratoryAccreditation", input:data);
            return Ok();
        }
    }
}
