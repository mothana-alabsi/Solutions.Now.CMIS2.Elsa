...
namespace Solutions.Now.CMIS2.Elsa.Controllers
{
    ...
    [ApiController]
    public class ConsultantStaffsController : ControllerBase
    {
        ISignaler _signaler;
        public ConsultantStaffsController(ISignaler signaler)
        {
            _signaler = signaler;
        }
        ...
        public async Task<IActionResult> Requset(int id)
        {
            ...
            await _signaler.TriggerSignalAsync("ConsultantStaff", input:data);
            return Ok();
        }
    }
}
