...
namespace Solutions.Now.CMIS2.Elsa.Controllers
{
    ...
    [ApiController]
    public class SiteDeliveriesController : ControllerBase
    {
        ISignaler _signaler;
        public SiteDeliveriesController(ISignaler signaler)
        {
            _signaler = signaler;
        }
        ...
        public async Task<IActionResult> Requset(int id)
        {
            ...
            await _signaler.TriggerSignalAsync("SiteDelivery", input:data);
            return Ok();
        }
    }
}
