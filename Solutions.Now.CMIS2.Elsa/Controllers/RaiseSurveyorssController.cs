...
namespace Solutions.Now.CMIS2.Elsa.Controllers
{
    ...
    [ApiController]
    public class RaiseSurveyorssController : ControllerBase
    {
        ISignaler _signaler;
        public RaiseSurveyorssController(ISignaler signaler)
        {
            _signaler = signaler;
        }
        ...
        public async Task<IActionResult> Requset(int id)
        {
            ...
            await _signaler.TriggerSignalAsync("RaiseSurveyors", input:data);
            return Ok();
        }
    }
}
