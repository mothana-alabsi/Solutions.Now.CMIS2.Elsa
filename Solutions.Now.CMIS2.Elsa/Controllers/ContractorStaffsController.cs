...
namespace Solutions.Now.CMIS2.Elsa.Controllers
{
    ...
    [ApiController]
    public class ContractorStaffsController : ControllerBase
    {
        ISignaler _signaler;
        public ContractorStaffsController(ISignaler signaler)
        {
            _signaler = signaler;
        }
        ...
        public async Task<IActionResult> Requset(int id)
        {
            ...
            await _signaler.TriggerSignalAsync("ContractorStaff", input:data);
            return Ok();
        }
    }
}
