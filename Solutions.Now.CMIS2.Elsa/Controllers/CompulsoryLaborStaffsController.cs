...
namespace Solutions.Now.CMIS2.Elsa.Controllers
{
    ...
    [ApiController]
    public class CompulsoryLaborStaffsController : ControllerBase
    {
        ISignaler _signaler;
        public CompulsoryLaborStaffsController(ISignaler signaler)
        {
            _signaler = signaler;
        }
        ...
        public async Task<IActionResult> Requset(int id)
        {
            ...
            await _signaler.TriggerSignalAsync("CompulsoryLaborStaff", input:data);
            return Ok();
        }
    }
}
